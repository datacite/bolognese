...
describe Bolognese::Metadata, vcr: true do
  context "write metadata as jats xml" do
    it "with data citation" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("eLife Sciences Publications, Ltd")
    ...
    it "with ORCID ID" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("Hindawi Limited")
    ...
    it "with editor" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("Public Library of Science (PLoS)")
    ...
    it "book chapter" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("Jaypee Brothers Medical Publishing")
    ...
    it "Crossref DOI" do
      ...
      expect(jats.dig("article_title")).to eq("Automated quantitative histology reveals vascular morphodynamics during Arabidopsis hypocotyl secondary growth")
      expect(jats.dig("source")).to eq("eLife")
      expect(jats.dig("publisher", "publisher_name")).to eq("{eLife} Sciences Organisation, Ltd.")
      expect(jats.dig("person_group", "name").length).to eq(5)
      expect(jats.dig("person_group", "name").first).to eq("surname"=>"Sankar", "given_names"=>"Martial")
    ...
    it "BlogPosting Citeproc JSON" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("DataCite")
    ...
    it "rdataone" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("https://cran.r-project.org")
    ...
    it "Text pass-thru" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("Figshare")
    ...
    it "Dataset in schema 4.0" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq(nil)
    ...
    it "interactive resource without dates" do
      ...
      expect(jats.dig("publisher", "publisher_name")).to eq("Gigantum, Inc.")
